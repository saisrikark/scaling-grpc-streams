...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/application.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) SayHellos(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHellosClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/application.Greeter/SayHellos", opts...)
	if err != nil {
		return nil, err
	}
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/application.Greeter/SayHello",
	}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "application.Greeter",
	...
	Metadata: "pkg/application/application.proto",
}
